...
public class DatabaseUsersLoader {
    ...
    private void initDatabase() throws IOException {
        ...
        userRepository.save(new User("admin", passwordEncoder.encode("Adminpass1@"), "USER", "ADMIN"));
        userRepository.save(new User("user", passwordEncoder.encode("Userpass1@"), "USER"));
        userRepository.save(new User("peter", passwordEncoder.encode("Peterpass1@"), "USER"));
